...
class Actualizar
{
    public static function actualizarEstudiantes()
    {
        ...
        $sqlUpdate = "UPDATE estudiantes SET nombre = '$datosPUT[nombre]', apellido = '$datosPUT[apellido]', direccion = '$datosPUT[direccion]', telefono = '$datosPUT[telefono]' WHERE cedula = '$cedula'";
